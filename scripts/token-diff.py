...
def main():
    ...
    for scope in ("all_time",):
        ...
        print("  ── AI credits + $ ──")
        diff_section("credits used",      get(o, "total_credits"),                  get(n, "total_credits"))
        diff_section("cost (USD)",        get(o, "total_cost_usd"),                 get(n, "total_cost_usd"))
        ...
        oc  = get(o, "total_credits")
        nc  = get(n, "total_credits")
        ou  = get(o, "total_cost_usd")
        nu  = get(n, "total_cost_usd")
        ...
        diff_section("avg credits/session",    round(oc/os_, 2), round(nc/ns_, 2))
        diff_section("avg USD/session",        round(ou/os_, 4), round(nu/ns_, 4))
        print()
